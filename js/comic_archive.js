...
writeArchive("chapter1", 1, 10, -1, true,false); //writeArchive is for listing a RANGE of pages, take advantage of this by using headers to divide them into chapters or by month

writeArchive("chapter2", 11, 20, -1, true,true);

writeArchive("chapter3", 21, 30, -1, true,true);

writeArchive("chapter4", 31, 40, -1, true,true);
